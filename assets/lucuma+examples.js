...
cljs.core.with_meta = function with_meta(b, c) {
  return function() {
    ...
    "undefined" === typeof cljs.core.t7758 && (cljs.core.t7758 = {}, cljs.core.t7758 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta7759 = g;
    ...
    }, cljs.core.t7758.cljs$lang$type = !0, cljs.core.t7758.cljs$lang$ctorStr = "cljs.core/t7758", cljs.core.t7758.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t7758")
    }, cljs.core.t7758.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t7758.prototype.apply = function(b, c) {
      b = this;
      return b.call.apply(b, [b].concat(c.slice()))
    }, cljs.core.t7758.prototype.cljs$core$Fn$ = !0, cljs.core.t7758.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta7759
    }, cljs.core.t7758.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t7758(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t7758 = function(b, c, f, g) {
      return new cljs.core.t7758(b, c, f, g)
    });
    return new cljs.core.t7758(c, b, with_meta, null)
...
var lucuma = {util:{}};
lucuma.util.resolve_goog_ns = function(a) {
  for(var b = window;;) {
    if(cljs.core.empty_QMARK_.call(null, a)) {
      return b
    }
    var c = cljs.core.rest.call(null, a), b = b[clojure.string.replace.call(null, cljs.core.first.call(null, a), /-/, "_")];
    a = c
  }
};
lucuma.util._STAR_ns_STAR___GT_goog_ns = function(a) {
  return lucuma.util.resolve_goog_ns.call(null, clojure.string.split.call(null, a, /\./))
};
lucuma.util.str__GT_fn = function(a) {
  a = cljs.core.second.call(null, cljs.core.re_find.call(null, /([^\(]*)(?:\([A-z]*\))?;?$/, a));
  return cljs.core.truth_(a) ? (a = clojure.string.split.call(null, a, /\./), lucuma.util.resolve_goog_ns.call(null, cljs.core.butlast.call(null, a))[cljs.core.last.call(null, a)]) : null
};
lucuma.util.call_with_first_argument = function() {
  var a = null, b = function(b, c) {
...
lucuma.util.wrap_with_callback_this_value = function(a) {
  return cljs.core.truth_(a) ? function() {
    var b = function(b) {
      return lucuma.util.call_with_first_argument.call(null, a, this, b)
    }, c = function(a) {
      var c = null;
      0 < arguments.length && (c = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
lucuma.util.invoke_if_fn = function(a) {
  return cljs.core.fn_QMARK_.call(null, a) ? a.call(null) : a
};
lucuma.util.warn = function(a) {
  return console.warn(cljs.core.clj__GT_js.call(null, a))
};
lucuma.attribute = {};
lucuma.attribute.get_attr = function(a, b) {
  return cljs.core.truth_(a.hasAttribute(cljs.core.name.call(null, b))) ? a.getAttribute(cljs.core.name.call(null, b)) : null
};
lucuma.attribute.set_attr_BANG_ = function(a, b, c) {
  return cljs.core.truth_(c) ? a.setAttribute(cljs.core.name.call(null, b), c) : a.removeAttribute(cljs.core.name.call(null, b))
};
lucuma.attribute.as_property = function(a) {
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "configurable", "configurable", 2184612523), !0, new cljs.core.Keyword(null, "enumerable", "enumerable", 4388194106), !0, new cljs.core.Keyword(null, "get", "get", 1014006472), lucuma.util.wrap_with_callback_this_value.call(null, function(b) {
    return lucuma.attribute.get_attr.call(null, b, a)
  }), new cljs.core.Keyword(null, "set", "set", 1014018004), lucuma.util.wrap_with_callback_this_value.call(null, function(b, c) {
    return lucuma.attribute.set_attr_BANG_.call(null, b, a, c)
  })], !0)
};
lucuma.attribute.properties = function(a) {
  return cljs.core.clj__GT_js.call(null, cljs.core.apply.call(null, cljs.core.merge, cljs.core.map.call(null, function(a) {
    return cljs.core.hash_map.call(null, cljs.core.keyword.call(null, a), lucuma.attribute.as_property.call(null, a))
  }, a)))
};
...
lucuma.custom_elements.create_prototype = function(a) {
  ...
  a = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "attribute-changed-fn", "attribute-changed-fn", 511779268));
  var c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "left-view-fn", "left-view-fn", 4756847772)), d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "entered-view-fn", "entered-view-fn", 3505744396)), e = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "created-fn", "created-fn", 2383536447)), f = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "properties", "properties", 4382818469)), b = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "prototype", 
  "prototype", 4710078612)), f = lucuma.attribute.properties.call(null, f), f = cljs.core.truth_(f) ? Object.create(b, f) : Object.create(b);
  f.createdCallback = lucuma.util.wrap_with_callback_this_value.call(null, e);
  f.enteredViewCallback = lucuma.util.wrap_with_callback_this_value.call(null, d);
  f.leftViewCallback = lucuma.util.wrap_with_callback_this_value.call(null, c);
  f.attributeChangedCallback = lucuma.util.wrap_with_callback_this_value.call(null, a);
  return f
};
lucuma.custom_elements.register = function(a, b, c) {
  ...
  return document.register(a, cljs.core.clj__GT_js.call(null, cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "prototype", "prototype", 4710078612), b], !0), cljs.core.truth_(c) ? cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "extends", "extends", 4003207179), c], !0) : null)))
};
var cemerick = {cljs:{}};
cemerick.cljs.test = {};
...
lucuma.shadow_dom = {};
lucuma.shadow_dom.create = function() {
  var a = null, b = function(b) {
    return a.call(null, b, cljs.core.PersistentArrayMap.EMPTY)
  }, c = function(a, b) {
    var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, g = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "reset-style-inheritance", "reset-style-inheritance", 1435321634)), c = cljs.core.get.call(null, c, new cljs.core.Keyword(null, "apply-author-styles", "apply-author-styles", 4411190967)), h = a.createShadowRoot();
    cljs.core.truth_(c) && (h.applyAuthorStyles = c);
    cljs.core.truth_(g) && (h.resetStyleInheritance = g);
    return h
  }, a = function(a, e) {
    switch(arguments.length) {
      case 1:
...
lucuma.LucumaElement = function() {
};
lucuma.LucumaElement.cljs$lang$type = !0;
lucuma.LucumaElement.cljs$lang$ctorStr = "lucuma/LucumaElement";
lucuma.LucumaElement.cljs$lang$ctorPrWriter = function(a, b, c) {
  return cljs.core._write.call(null, b, "lucuma/LucumaElement")
};
lucuma.__GT_LucumaElement = function() {
  return new lucuma.LucumaElement
};
lucuma.lucuma_element_QMARK_ = function(a) {
  return a instanceof lucuma.LucumaElement
};
lucuma.create_lucuma_prototype = function(a) {
  lucuma.LucumaElement.prototype = a;
  return lucuma.LucumaElement.prototype
};
lucuma.install_shadow_css_shim_when_needed = function(a, b, c) {
  return cljs.core.truth_(ShadowDOMPolyfill) ? cljs.core.truth_(c) ? Platform.ShadowCSS.shimStyling(a, b, cljs.core.name.call(null, c)) : Platform.ShadowCSS.shimStyling(a, b) : null
};
lucuma.render_content = function() {
  var a = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY), b = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY), c = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY), d = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY), e = cljs.core.get.call(null, cljs.core.PersistentArrayMap.EMPTY, new cljs.core.Keyword(null, "hierarchy", "hierarchy", 3129050535), cljs.core.get_global_hierarchy.call(null));
...
cljs.core._add_method.call(null, lucuma.render_content, String, function(a) {
  return a
});
...
lucuma.render_then_append_content_BANG_ = function(a, b) {
  ...
  if(cljs.core.truth_(c)) {
    if(cljs.core.coll_QMARK_.call(null, c)) {
      for(var c = cljs.core.seq.call(null, c), d = null, e = 0, f = 0;;) {
        if(f < e) {
          var g = cljs.core._nth.call(null, d, f);
          lucuma.append_content_BANG_.call(null, a, g);
          f += 1
        }else {
          if(c = cljs.core.seq.call(null, c)) {
            d = c, cljs.core.chunked_seq_QMARK_.call(null, d) ? (c = cljs.core.chunk_first.call(null, d), e = cljs.core.chunk_rest.call(null, d), d = c, g = cljs.core.count.call(null, c), c = e, e = g) : (g = cljs.core.first.call(null, d), lucuma.append_content_BANG_.call(null, a, g), c = cljs.core.next.call(null, d), d = null, e = 0), f = 0
          }else {
            return null
          }
        }
      ...
      return lucuma.append_content_BANG_.call(null, a, c)
    }
  }else {
    return null
  }
...
lucuma.adjust_listener = function(a, b, c, d) {
  ...
  return null == c ? a.addEventListener(b, d) : a.removeEventListener(b, d)
};
lucuma.event__GT_handler = function(a) {
  return[cljs.core.str("on"), cljs.core.str(cljs.core.name.call(null, a))].join("")
};
lucuma.handler__GT_event = function(a) {
  return a.substr(2)
};
lucuma.attribute_changed = function(a, b, c, d, e, f) {
  return cljs.core.contains_QMARK_.call(null, f, b) ? (b = lucuma.handler__GT_event.call(null, b), lucuma.adjust_listener.call(null, a, b, c, d)) : null
};
lucuma.initialize_BANG_ = function(a, b, c, d, e) {
  for(var f = cljs.core.seq_QMARK_.call(null, c) ? cljs.core.apply.call(null, cljs.core.hash_map, c) : c, g = cljs.core.get.call(null, f, new cljs.core.Keyword(null, "style", "style", 1123684643)), f = cljs.core.get.call(null, f, new cljs.core.Keyword(null, "content", "content", 1965434859)), h = cljs.core.seq.call(null, cljs.core.array_seq.call(null, a.attributes)), k = null, l = 0, m = 0;;) {
    if(m < l) {
      var n = cljs.core._nth.call(null, k, m);
      lucuma.attribute_changed.call(null, a, n.name, null, n.value, d, e);
      m += 1
    }else {
      if(h = cljs.core.seq.call(null, h)) {
        k = h, cljs.core.chunked_seq_QMARK_.call(null, k) ? (h = cljs.core.chunk_first.call(null, k), m = cljs.core.chunk_rest.call(null, k), k = h, l = cljs.core.count.call(null, h), h = m) : (h = cljs.core.first.call(null, k), lucuma.attribute_changed.call(null, a, h.name, null, h.value, d, e), h = cljs.core.next.call(null, k), k = null, l = 0), m = 0
      }else {
        break
      }
    }
  }
  lucuma.create_shadow_root_BANG_.call(null, a, f, g, c);
  cljs.core.truth_(g) && lucuma.install_shadow_css_shim_when_needed.call(null, a.shadowRoot, (new cljs.core.Keyword(null, "name", "name", 1017277949)).call(null, c), (new cljs.core.Keyword(null, "base-type", "base-type", 3446290472)).call(null, c));
  return cljs.core.truth_(b) ? lucuma.util.call_with_first_argument.call(null, b, a) : null
};
lucuma.create_prototype = function(a) {
  for(var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, c = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "handlers", "handlers", 1015973339)), d = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "methods", "methods", 1969438500)), e = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "attributes", "attributes", 1419549897)), f = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "created-fn", "created-fn", 2383536447)), 
  g = cljs.core.get.call(null, b, new cljs.core.Keyword(null, "base-type", "base-type", 3446290472)), h = cljs.core.set.call(null, cljs.core.map.call(null, cljs.core.name, e)), k = cljs.core.set.call(null, cljs.core.map.call(null, lucuma.event__GT_handler, c)), l = function(b, c, d, e, f, g, h, k, l) {
    return function(b) {
      return lucuma.initialize_BANG_.call(null, b, g, a, k, l)
    }
  }(a, b, c, d, e, f, g, h, k), b = function(a, b, c, d, e, f, g, h, k, l) {
    return function(a, b, c, d) {
      return lucuma.attribute_changed.call(null, a, b, c, d, h, k)
    }
  }(a, b, c, d, e, f, g, h, k, l), g = cljs.core.truth_(g) ? cljs.core.name.call(null, g) : null, g = lucuma.create_lucuma_prototype.call(null, lucuma.custom_elements.find_prototype.call(null, g)), h = lucuma.custom_elements.create_prototype.call(null, cljs.core.merge.call(null, a, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "prototype", "prototype", 4710078612), g, new cljs.core.Keyword(null, "properties", "properties", 4382818469), cljs.core.concat.call(null, h, k), new cljs.core.Keyword(null, 
  "created-fn", "created-fn", 2383536447), l, new cljs.core.Keyword(null, "attribute-changed-fn", "attribute-changed-fn", 511779268), b], !0))), d = cljs.core.seq.call(null, d), k = null, g = l = 0;;) {
    if(g < l) {
      b = cljs.core._nth.call(null, k, g), h[cljs.core.name.call(null, cljs.core.key.call(null, b))] = lucuma.util.wrap_with_callback_this_value.call(null, cljs.core.val.call(null, b)), g += 1
    }else {
      if(d = cljs.core.seq.call(null, d)) {
        k = d, cljs.core.chunked_seq_QMARK_.call(null, k) ? (d = cljs.core.chunk_first.call(null, k), g = cljs.core.chunk_rest.call(null, k), k = d, l = cljs.core.count.call(null, d), d = g) : (d = cljs.core.first.call(null, k), h[cljs.core.name.call(null, cljs.core.key.call(null, d))] = lucuma.util.wrap_with_callback_this_value.call(null, cljs.core.val.call(null, d)), d = cljs.core.next.call(null, k), k = null, l = 0), g = 0
      }else {
        break
      }
    }
...
lucuma.default_constructor_name = function(a) {
  return null != a ? (a = clojure.string.split.call(null, a, /-/), [cljs.core.str(clojure.string.upper_case.call(null, cljs.core.get.call(null, a, 0))), cljs.core.str(clojure.string.join.call(null, cljs.core.map.call(null, clojure.string.capitalize, cljs.core.subvec.call(null, a, 1))))].join("")) : null
};
lucuma.register = function(a) {
  var b = (new cljs.core.Keyword(null, "name", "name", 1017277949)).call(null, a), c = (new cljs.core.Keyword(null, "constructor", "constructor", 3720465260)).call(null, a, lucuma.default_constructor_name.call(null, b)), d = lucuma.custom_elements.register.call(null, b, lucuma.create_prototype.call(null, a), (new cljs.core.Keyword(null, "base-type", "base-type", 3446290472)).call(null, a)), e = lucuma.util._STAR_ns_STAR___GT_goog_ns.call(null, (new cljs.core.Keyword(null, "ns", "ns", 1013907767)).call(null, 
  a));
  return cljs.core.truth_(e) ? cljs.core.truth_(c) ? e[c] = d : null : lucuma.util.warn.call(null, [cljs.core.str("Couldn't export constructor for "), cljs.core.str(b), cljs.core.str(" as ns "), cljs.core.str((new cljs.core.Keyword(null, "ns", "ns", 1013907767)).call(null, a)), cljs.core.str(" is inaccessible")].join(""))
};
var lucuma_test = {default_constructor_names:function() {
  return cemerick.cljs.test.test_var.call(null, lucuma_test.default_constructor_names)
}};
lucuma_test.default_constructor_names = cljs.core.vary_meta.call(null, lucuma_test.default_constructor_names, cljs.core.assoc, new cljs.core.Keyword(null, "name", "name", 1017277949), new cljs.core.Symbol(null, "default-constructor-names", "default-constructor-names", -1566916382, null), new cljs.core.Keyword(null, "test", "test", 1017460740), function() {
  try {
    var a = cljs.core.list.call(null, "EXName", lucuma.default_constructor_name.call(null, "ex-name")), b = cljs.core.apply.call(null, cljs.core._EQ_, a);
    ...
    "\x3d", "\x3d", -1640531466, null), "EXName", cljs.core.list(new cljs.core.Symbol("l", "default-constructor-name", "l/default-constructor-name", -2053791950, null), "ex-name"))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), 
    a)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), "EXName", cljs.core.list(new cljs.core.Symbol("l", "default-constructor-name", "l/default-constructor-name", -2053791950, null), "ex-name"))], !0))
  }catch(c) {
    if(c instanceof Error) {
      cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), c, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), "EXName", cljs.core.list(new cljs.core.Symbol("l", 
      "default-constructor-name", "l/default-constructor-name", -2053791950, null), "ex-name"))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw c;
      }
  ...
  try {
    var d = cljs.core.list.call(null, "EXComplexName", lucuma.default_constructor_name.call(null, "ex-complex-name")), e = cljs.core.apply.call(null, cljs.core._EQ_, d);
    ...
    "\x3d", "\x3d", -1640531466, null), "EXComplexName", cljs.core.list(new cljs.core.Symbol("l", "default-constructor-name", "l/default-constructor-name", -2053791950, null), "ex-complex-name"))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "\x3d", "\x3d", 
    -1640531466, null), d)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), "EXComplexName", cljs.core.list(new cljs.core.Symbol("l", "default-constructor-name", "l/default-constructor-name", -2053791950, null), "ex-complex-name"))], 
    !0));
    return e
  }catch(f) {
    if(f instanceof Error) {
      ...
      cljs.core.list(new cljs.core.Symbol("l", "default-constructor-name", "l/default-constructor-name", -2053791950, null), "ex-complex-name"))], !0))
    }
    if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
      throw f;
    }
...
cemerick.cljs.test.register_test_BANG_.call(null, new cljs.core.Symbol(null, "lucuma-test", "lucuma-test", 316783305, null), lucuma_test.default_constructor_names);
lucuma.util_test = {};
lucuma.util_test.two = function() {
  return 2
};
goog.exportSymbol("lucuma.util_test.two", lucuma.util_test.two);
cljs.core.truth_(window.lucuma) && (lucuma.util_test.resolve_goog_ns = function() {
  return cemerick.cljs.test.test_var.call(null, lucuma.util_test.resolve_goog_ns)
}, lucuma.util_test.resolve_goog_ns = cljs.core.vary_meta.call(null, lucuma.util_test.resolve_goog_ns, cljs.core.assoc, new cljs.core.Keyword(null, "name", "name", 1017277949), new cljs.core.Symbol(null, "resolve-goog-ns", "resolve-goog-ns", 1905373386, null), new cljs.core.Keyword(null, "test", "test", 1017460740), function() {
  try {
    var a = cljs.core.list.call(null, null == lucuma.util.resolve_goog_ns.call(null, cljs.core.list.call(null, "lucuma"))), b = cljs.core.apply.call(null, cljs.core.not, a);
    ...
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma"))))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), a)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", 
    "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma"))))], !0))
  }catch(c) {
    if(c instanceof Error) {
      ...
      "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma"))))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw c;
      }
  ...
  try {
    var d = cljs.core.list.call(null, null == lucuma.util.resolve_goog_ns.call(null, cljs.core.list.call(null, "lucuma", "util-test"))), e = cljs.core.apply.call(null, cljs.core.not, d);
    cljs.core.truth_(e) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core.not, d), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util-test"))))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), d)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", 
    "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util-test"))))], !0))
  }catch(f) {
    if(f instanceof Error) {
      cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), f, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, 
      "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util-test"))))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw f;
      }
  ...
  try {
    var g = cljs.core.list.call(null, null == lucuma.util.resolve_goog_ns.call(null, cljs.core.list.call(null, "lucuma", "util_test"))), h = cljs.core.apply.call(null, cljs.core.not, g);
    cljs.core.truth_(h) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core.not, g), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util_test"))))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), g)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", 
    "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util_test"))))], !0))
  }catch(k) {
    if(k instanceof Error) {
      ...
      "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util_test"))))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw k;
      }
  ...
  try {
    var l = cljs.core.list.call(null, null == lucuma.util.resolve_goog_ns.call(null, cljs.core.list.call(null, "lucuma", "util_test")).two), m = cljs.core.apply.call(null, cljs.core.not, l);
    cljs.core.truth_(m) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core.not, l), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol(null, "aget", "aget", -1637539570, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util_test")), "two")))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, 
    "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), l)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol(null, "aget", "aget", -1637539570, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util_test")), "two")))], !0))
  }catch(n) {
    if(n instanceof Error) {
      ...
      "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol(null, "aget", "aget", -1637539570, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "util_test")), "two")))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw n;
      }
  ...
  try {
    var p = cljs.core.list.call(null, lucuma.util.resolve_goog_ns.call(null, cljs.core.list.call(null, "lucuma", "non-existent"))), q = cljs.core.apply.call(null, cljs.core.not, p);
    cljs.core.truth_(q) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core.not, p), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "non-existent")))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, 
    new cljs.core.Symbol(null, "not", "not", -1640422260, null), p)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol("u", "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, 
    "list", "list", -1637209513, null), "lucuma", "non-existent")))], !0));
    return q
  }catch(r) {
    if(r instanceof Error) {
      return cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), r, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol("u", 
      "resolve-goog-ns", "u/resolve-goog-ns", 1905380946, null), cljs.core.list(new cljs.core.Symbol(null, "list", "list", -1637209513, null), "lucuma", "non-existent")))], !0))
    }
    if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
      throw r;
    }
...
}), cemerick.cljs.test.register_test_BANG_.call(null, new cljs.core.Symbol(null, "lucuma.util-test", "lucuma.util-test", 216413335, null), lucuma.util_test.resolve_goog_ns), lucuma.util_test.str__GT_fn = function() {
  return cemerick.cljs.test.test_var.call(null, lucuma.util_test.str__GT_fn)
}, lucuma.util_test.str__GT_fn = cljs.core.vary_meta.call(null, lucuma.util_test.str__GT_fn, cljs.core.assoc, new cljs.core.Keyword(null, "name", "name", 1017277949), new cljs.core.Symbol(null, "str-\x3efn", "str-\x3efn", 770843043, null), new cljs.core.Keyword(null, "test", "test", 1017460740), function() {
  try {
    var a = cljs.core.list.call(null, null == lucuma.util.str__GT_fn.call(null, "lucuma.util_test.two")), b = cljs.core.apply.call(null, cljs.core.not, a);
    cljs.core.truth_(b) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core.not, a), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two")))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), a)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 
    770850677, null), "lucuma.util_test.two")))], !0))
  }catch(c) {
    if(c instanceof Error) {
      cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), c, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, 
      "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two")))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw c;
      }
  ...
  try {
    var d = cljs.core.list.call(null, 2, lucuma.util.str__GT_fn.call(null, "lucuma.util_test.two").call(null)), e = cljs.core.apply.call(null, cljs.core._EQ_, d);
    cljs.core.truth_(e) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core._EQ_, d), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "\x3d", "\x3d", -1640531466, null), 2, cljs.core.list(cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two")))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), d)), 
    new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), 2, cljs.core.list(cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two")))], !0))
  }catch(f) {
    if(f instanceof Error) {
      cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), f, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), 2, cljs.core.list(cljs.core.list(new cljs.core.Symbol("u", 
      "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two")))], !0))
    }else {
      if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
        throw f;
      }
  ...
  try {
    var g = cljs.core.list.call(null, 2, lucuma.util.str__GT_fn.call(null, "lucuma.util_test.two()").call(null)), h = cljs.core.apply.call(null, cljs.core._EQ_, g);
    cljs.core.truth_(h) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core._EQ_, g), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "\x3d", "\x3d", -1640531466, null), 2, cljs.core.list(cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two()")))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), 
    g)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), 2, cljs.core.list(cljs.core.list(new cljs.core.Symbol("u", "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two()")))], !0));
    return h
  }catch(k) {
    if(k instanceof Error) {
      return cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), k, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "\x3d", "\x3d", -1640531466, null), 2, cljs.core.list(cljs.core.list(new cljs.core.Symbol("u", 
      "str-\x3efn", "u/str-\x3efn", 770850677, null), "lucuma.util_test.two()")))], !0))
    }
    if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
      throw k;
...
}), cemerick.cljs.test.register_test_BANG_.call(null, new cljs.core.Symbol(null, "lucuma.util-test", "lucuma.util-test", 216413335, null), lucuma.util_test.str__GT_fn));
...
lucuma.shadow_dom_test.create = cljs.core.vary_meta.call(null, lucuma.shadow_dom_test.create, cljs.core.assoc, new cljs.core.Keyword(null, "name", "name", 1017277949), new cljs.core.Symbol(null, "create", "create", 1302141621, null), new cljs.core.Keyword(null, "test", "test", 1017460740), function() {
  try {
    var a = cljs.core.list.call(null, null == lucuma.shadow_dom.create.call(null, document.createElement("a"))), b = cljs.core.apply.call(null, cljs.core.not, a);
    cljs.core.truth_(b) ? cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), cljs.core.cons.call(null, cljs.core.not, a), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "pass", "pass", 1017337731), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, 
    "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("sd", "create", "sd/create", 1302379736, null), cljs.core.list(new cljs.core.Symbol(null, ".createElement", ".createElement", 1457256107, null), new cljs.core.Symbol("js", "document", "js/document", -778588881, null), "a"))))], !0)) : cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", 
    "actual", 3885931776), cljs.core.list.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.cons.call(null, new cljs.core.Symbol(null, "not", "not", -1640422260, null), a)), new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "fail", "fail", 1017039504), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", 
    "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("sd", "create", "sd/create", 1302379736, null), cljs.core.list(new cljs.core.Symbol(null, ".createElement", ".createElement", 1457256107, null), new cljs.core.Symbol("js", "document", "js/document", -778588881, null), "a"))))], !0));
    return b
  }catch(c) {
    if(c instanceof Error) {
      return cemerick.cljs.test.do_report.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "actual", "actual", 3885931776), c, new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword(null, "error", "error", 1110689146), new cljs.core.Keyword(null, "message", "message", 1968829305), null, new cljs.core.Keyword(null, "expected", "expected", 3373152810), cljs.core.list(new cljs.core.Symbol(null, "not", "not", -1640422260, null), cljs.core.list(new cljs.core.Symbol(null, 
      "nil?", "nil?", -1637150201, null), cljs.core.list(new cljs.core.Symbol("sd", "create", "sd/create", 1302379736, null), cljs.core.list(new cljs.core.Symbol(null, ".createElement", ".createElement", 1457256107, null), new cljs.core.Symbol("js", "document", "js/document", -778588881, null), "a"))))], !0))
    }
    if(new cljs.core.Keyword(null, "else", "else", 1017020587)) {
      throw c;
    }
...
try {
  ...
  if(e9370 instanceof ReferenceError) {
    var __9371 = e9370;
...
dommy.core.selector_map = function selector_map(b, c) {
  ...
  return cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "container", "container", 602947571), d], !0), cljs.core.into.call(null, cljs.core.PersistentArrayMap.EMPTY, cljs.core.map.call(null, function(e) {
    ...
    return cljs.core.PersistentVector.fromArray([f, cljs.core.truth_((new cljs.core.Keyword(null, "live", "live", 1017226334)).call(null, cljs.core.meta.call(null, g))) ? function() {
      "undefined" === typeof dommy.core.t8903 && (dommy.core.t8903 = {}, dommy.core.t8903 = function(b, c, d, e, f, g, q, r, s) {
        this.v = b;
        this.k = c;
        this.vec__8902 = d;
        this.p__8901 = e;
      ...
      }, dommy.core.t8903.cljs$lang$type = !0, dommy.core.t8903.cljs$lang$ctorStr = "dommy.core/t8903", dommy.core.t8903.cljs$lang$ctorPrWriter = function(b, c, d) {
        return cljs.core._write.call(null, c, "dommy.core/t8903")
      }, dommy.core.t8903.prototype.cljs$core$IDeref$_deref$arity$1 = function(b) {
      ...
      }, dommy.core.t8903.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
        return this.meta8904
      }, dommy.core.t8903.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new dommy.core.t8903(this.v, this.k, this.vec__8902, this.p__8901, this.container, this.key_selectors_map, this.template, this.selector_map, c)
      }, dommy.core.__GT_t8903 = function(b, c, d, e, f, g, q, r, s) {
        return new dommy.core.t8903(b, c, d, e, f, g, q, r, s)
      });
      return new dommy.core.t8903(g, f, e, e, d, c, b, selector_map, null)
...
lucuma.event.create_event = function(a, b, c, d) {
  var e;
  if(e = cljs.core.empty_QMARK_.call(null, b)) {
    e = (e = cljs.core.not.call(null, c)) ? cljs.core.not.call(null, d) : e
  }
  return e ? new CustomEvent(cljs.core.name.call(null, a)) : new CustomEvent(cljs.core.name.call(null, a), cljs.core.clj__GT_js.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "bubbles", "bubbles", 1238094041), c, new cljs.core.Keyword(null, "cancelable", "cancelable", 2902911558), d, new cljs.core.Keyword(null, "detail", "detail", 3973647299), b], !0)))
};
...
lucuma.overlay = {};
lucuma.overlay.style = cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "body", "body", 1016933652), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "overflow", "overflow", 1543546740), "visible", new cljs.core.Keyword(null, "overflow-y", "overflow-y", 3194205408), "scroll"], !0)], !0), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, ".overlay-backdrop-active", ".overlay-backdrop-active", 3945912420), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, 
"body", "body", 1016933652), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "overflow", "overflow", 1543546740), "hidden"], !0)], !0)], !0), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, ".b-overlay-backdrop", ".b-overlay-backdrop", 3653671774), cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null, "bottom", "bottom", 3925642653), new cljs.core.Keyword(null, "position", "position", 1761709211), new cljs.core.Keyword(null, "display", "display", 
2685668404), new cljs.core.Keyword(null, "z-index", "z-index", 3303828785), new cljs.core.Keyword(null, "overflow-x", "overflow-x", 3194205407), new cljs.core.Keyword(null, "overflow-y", "overflow-y", 3194205408), new cljs.core.Keyword(null, "top", "top", 1014019271), new cljs.core.Keyword(null, "right", "right", 1122416014), new cljs.core.Keyword(null, "left", "left", 1017222009), new cljs.core.Keyword(null, "background-color", "background-color", 1619226998)], [0, "fixed", "none", 998, "auto", 
"scroll", 0, 0, 0, garden.color.rgba.call(null, 252, 252, 252, 0.7)])], !0), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, ".b-overlay-backdrop-close", ".b-overlay-backdrop-close", 2212228169), cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null, "border", "border", 3925567390), new cljs.core.Keyword(null, "position", "position", 1761709211), new cljs.core.Keyword(null, "width", "width", 1127031096), new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, 
...
lucuma.overlay.hide = function(a) {
  ...
  return lucuma.event.fire.call(null, a, new cljs.core.Keyword(null, "hide", "hide", 1017106612))
};
lucuma.overlay.show = function(a) {
  ...
  return lucuma.event.fire.call(null, a, new cljs.core.Keyword(null, "show", "show", 1017433711))
};
lucuma.overlay.lucu_overlay = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.overlay", new cljs.core.Keyword(null, "name", "name", 1017277949), "lucu-overlay"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "content", "content", 1965434859), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "div", "div", 1014003715), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, 
"class", "class", 1108647146), "b-overlay-backdrop q-b-overlay-backdrop"], !0), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "div", "div", 1014003715), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "class", "class", 1108647146), "b-overlay-backdrop-close q-b-overlay-backdrop-close", new cljs.core.Keyword(null, "title", "title", 1124275658), "Press ESC to close"], !0), "x"], !0), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "div", "div", 
1014003715), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "class", "class", 1108647146), "b-overlay-body q-overlay"], !0), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "content", "content", 1965434859)], !0)], !0)], !0), new cljs.core.Keyword(null, "style", "style", 1123684643), lucuma.overlay.style, new cljs.core.Keyword(null, "methods", "methods", 1969438500), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "show", "show", 1017433711), 
lucuma.overlay.show, new cljs.core.Keyword(null, "hide", "hide", 1017106612), lucuma.overlay.hide], !0), new cljs.core.Keyword(null, "extends", "extends", 4003207179), new cljs.core.Keyword(null, "div", "div", 1014003715)], !0));
goog.exportSymbol("lucuma.overlay.lucu_overlay", lucuma.overlay.lucu_overlay);
lucuma.flipbox = {};
...
lucuma.flipbox.toggle = function(a) {
  return lucuma.attribute.set_attr_BANG_.call(null, a, new cljs.core.Keyword(null, "flipped", "flipped", 4537331956), cljs.core.not.call(null, lucuma.attribute.get_attr.call(null, a, new cljs.core.Keyword(null, "flipped", "flipped", 4537331956))))
};
lucuma.flipbox.show_front = function(a) {
  return lucuma.attribute.set_attr_BANG_.call(null, a, new cljs.core.Keyword(null, "flipped", "flipped", 4537331956), !0)
};
lucuma.flipbox.show_back = function(a) {
  return lucuma.attribute.set_attr_BANG_.call(null, a, new cljs.core.Keyword(null, "flipped", "flipped", 4537331956), !1)
};
...
goog.exportSymbol("lucuma.flipbox.lucu_flipbox", lucuma.flipbox.lucu_flipbox);
lucuma.example = {};
...
goog.exportSymbol("lucuma.example.lucu_example", lucuma.example.lucu_example);
...
lucuma.range_with_threshold.breach_threshold = function(a, b, c) {
  ...
  return lucuma.event.fire.call(null, a, new cljs.core.Keyword(null, "threshold-cross", "threshold-cross", 788744144), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword("lucuma.range-with-threshold", "breached", "lucuma.range-with-threshold/breached", 4733291423), new cljs.core.Keyword(null, "value", "value", 1125876963), b, new cljs.core.Keyword(null, "threshold", "threshold", 3763394525), c], !0))
};
lucuma.range_with_threshold.clear_threshold = function(a, b) {
  ...
  return lucuma.event.fire.call(null, a, new cljs.core.Keyword(null, "threshold-cross", "threshold-cross", 788744144), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "type", "type", 1017479852), new cljs.core.Keyword("lucuma.range-with-threshold", "cleared", "lucuma.range-with-threshold/cleared", 3349638299), new cljs.core.Keyword(null, "value", "value", 1125876963), b], !0))
};
lucuma.range_with_threshold.fire_event_on_threshold_cross = function(a, b, c) {
  var d = function() {
    var b = a.value;
    return cljs.core.truth_(b) ? b : a.impl.value
  }(), e = cljs.core.deref.call(null, lucuma.range_with_threshold.previous_value);
  cljs.core.truth_(function() {
    var a;
    a = (a = e < b) ? d >= b : a;
    return cljs.core.truth_(a) ? a : (a = e > c) ? d <= c : a
  }()) ? lucuma.range_with_threshold.clear_threshold.call(null, a, d) : function() {
    var a = e > b;
    return a ? (a = e < c) ? d <= b : a : a
  }() ? lucuma.range_with_threshold.breach_threshold.call(null, a, d, b) : function() {
    var a = e > b;
    return a ? (a = e < c) ? d >= c : a : a
  }() && lucuma.range_with_threshold.breach_threshold.call(null, a, d, c);
  return cljs.core.reset_BANG_.call(null, lucuma.range_with_threshold.previous_value, d)
};
lucuma.range_with_threshold.initialize = function(a, b, c) {
  ...
  cljs.core.reset_BANG_.call(null, lucuma.range_with_threshold.previous_value, d);
  return a.addEventListener("change", function(a) {
    return lucuma.range_with_threshold.fire_event_on_threshold_cross.call(null, a.target, b, c)
  }, !1)
};
lucuma.range_with_threshold.lucu_range_with_threshold = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.range-with-threshold", new cljs.core.Keyword(null, "name", "name", 1017277949), "lucu-range-with-threshold"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "style", "style", 1123684643), "input[type\x3d'range'] .threshold-crossed { background-color: red; }", new cljs.core.Keyword(null, "attributes", 
"attributes", 1419549897), cljs.core.PersistentHashSet.fromArray([new cljs.core.Keyword(null, "max-threshold", "max-threshold", 4639355572), null, new cljs.core.Keyword(null, "min-threshold", "min-threshold", 2166694434), null], !0), new cljs.core.Keyword(null, "handlers", "handlers", 1015973339), cljs.core.PersistentHashSet.fromArray([new cljs.core.Keyword(null, "threshold-cross", "threshold-cross", 788744144), null], !0), new cljs.core.Keyword(null, "created-fn", "created-fn", 2383536447), function(a) {
  return lucuma.range_with_threshold.initialize.call(null, a, function() {
    var b = lucuma.attribute.get_attr.call(null, a, new cljs.core.Keyword(null, "min-threshold", "min-threshold", 2166694434));
    return cljs.core.truth_(b) ? b : 10
  }(), function() {
    var b = lucuma.attribute.get_attr.call(null, a, new cljs.core.Keyword(null, "max-threshold", "max-threshold", 4639355572));
    return cljs.core.truth_(b) ? b : 30
  }())
}, new cljs.core.Keyword(null, "extends", "extends", 4003207179), new cljs.core.Keyword(null, "input", "input", 1114262332)], !0));
goog.exportSymbol("lucuma.range_with_threshold.lucu_range_with_threshold", lucuma.range_with_threshold.lucu_range_with_threshold);
garden.compiler = {};
...
lucuma.examples = {};
lucuma.examples.ex_hello = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.examples", new cljs.core.Keyword(null, "name", "name", 1017277949), "ex-hello"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "content", "content", 1965434859), "Hello world!"], !0));
goog.exportSymbol("lucuma.examples.ex_hello", lucuma.examples.ex_hello);
lucuma.examples.ex_lifecycle = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.examples", new cljs.core.Keyword(null, "name", "name", 1017277949), "ex-lifecycle"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "left-view-fn", "left-view-fn", 4756847772), function() {
...
goog.exportSymbol("lucuma.examples.ex_lifecycle", lucuma.examples.ex_lifecycle);
lucuma.examples.ex_content_template = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.examples", new cljs.core.Keyword(null, "name", "name", 1017277949), "ex-content-template"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "content", "content", 1965434859), function() {
  return document.getElementById("template-id")
}], !0));
goog.exportSymbol("lucuma.examples.ex_content_template", lucuma.examples.ex_content_template);
...
cljs.core._add_method.call(null, lucuma.render_content, new cljs.core.Keyword("lucuma.examples", "vector", "lucuma.examples/vector", 4458923423), function(a) {
  return cljs.core.vector_QMARK_.call(null, cljs.core.first.call(null, a)) ? cljs.core.map.call(null, function(a) {
...
goog.exportSymbol("lucuma.examples.ex_content_hiccup", lucuma.examples.ex_content_hiccup);
...
goog.exportSymbol("lucuma.examples.ex_style", lucuma.examples.ex_style);
...
goog.exportSymbol("lucuma.examples.ex_style_garden", lucuma.examples.ex_style_garden);
...
goog.exportSymbol("lucuma.examples.ex_style_scope", lucuma.examples.ex_style_scope);
...
goog.exportSymbol("lucuma.examples.ex_attributes", lucuma.examples.ex_attributes);
lucuma.examples.alert = function(a) {
  return window.alert([cljs.core.str("Hello methods from '"), cljs.core.str(a.id), cljs.core.str("' !")].join(""))
};
lucuma.examples.ex_methods = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.examples", new cljs.core.Keyword(null, "name", "name", 1017277949), "ex-methods"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "methods", "methods", 1969438500), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "method", "method", 4231316563), lucuma.examples.alert], !0)], !0));
goog.exportSymbol("lucuma.examples.ex_methods", lucuma.examples.ex_methods);
lucuma.examples.fire_event = function(a) {
  return lucuma.event.fire.call(null, document.querySelector(dommy.core.selector.call(null, cljs.core.keyword.call(null, a))), new cljs.core.Keyword(null, "event", "event", 1110795788), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "msg", "msg", 1014012659), "Sent from CLJS"], !0))
};
goog.exportSymbol("lucuma.examples.fire_event", lucuma.examples.fire_event);
lucuma.examples.ex_events = cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "ns", "ns", 1013907767), "lucuma.examples", new cljs.core.Keyword(null, "name", "name", 1017277949), "ex-events"], !0), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "handlers", "handlers", 1015973339), cljs.core.PersistentHashSet.fromArray([new cljs.core.Keyword(null, "event", "event", 1110795788), null], !0)], !0));
goog.exportSymbol("lucuma.examples.ex_events", lucuma.examples.ex_events);
...
goog.exportSymbol("lucuma.examples.ex_constructor", lucuma.examples.ex_constructor);
...
lucuma.examples.register_all = function() {
  ...
  lucuma.register.call(null, lucuma.examples.ex_style);
  lucuma.register.call(null, lucuma.examples.ex_style_garden);
  lucuma.register.call(null, lucuma.examples.ex_style_scope);
  lucuma.register.call(null, lucuma.examples.ex_extend);
  lucuma.register.call(null, lucuma.examples.ex_attributes);
  lucuma.register.call(null, lucuma.examples.ex_methods);
  lucuma.register.call(null, lucuma.examples.ex_events);
...
//@ sourceMappingURL=lucuma+examples.js.map